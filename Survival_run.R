# survival outcome
source("~/Prep_Survival.R")
source("~/Methods_Survival.R")
table=NULL
betahat_T=NULL
...
######## SIPTW
start.time <- Sys.time()
tableALL.SIPTW.surv.aft.try=SIPTW.aft(X, nT, DA, A, N, Index_T_HC0, Index_T_HC1, ATT.surv)
...
##### JFM1
tableALL.JFM1.surv.aft=JFM1.aft(X, nT, DA, A, N, Index_T_HC0, Index_T_HC1, ATT.surv, D, DD, Index_noC)
rownames(tableALL.JFM1.surv.aft)="JFM1.aft"
tableALL.JFM1.w.surv.aft=JFM1.aft(X.w, nT.w, DA.w, A.w, N.w, Index.w_T_HC0, Index.w_T_HC1, ATT.surv.w, D.w, DD.w, Index.w_noC)
rownames(tableALL.JFM1.w.surv.aft)="JFM1.w.aft"
####### JIPTW1
start.time <- Sys.time()
tableALL.JIPTW1.surv.aft=JIPTW1.aft(X, nT, DA, A, N, Index_T_HC0, Index_T_HC1, ATT.surv, D, DD, Index_noC)
rownames(tableALL.JIPTW1.surv.aft)="JIPTW1.aft"
tableALL.JIPTW1.w.surv.aft=JIPTW1.aft(X.w, nT.w, DA.w, A.w, N.w, Index.w_T_HC0, Index.w_T_HC1, ATT.surv.w, D.w, DD.w, Index.w_noC)
rownames(tableALL.JIPTW1.w.surv.aft)="JIPTW1.w.aft"
end.time <- Sys.time()
end.time - start.time
##### JFM2
...
##### JFM1
tableALL.JFM1.surv=JFM1(X, nT, DA, A, N, Index_T_HC0, Index_T_HC1, ATT.surv, D, DD, Index_noC)
rownames(tableALL.JFM1.surv)="JFM1"
tableALL.JFM1.w.surv=JFM1(X.w, nT.w, DA.w, A.w, N.w, Index.w_T_HC0, Index.w_T_HC1, ATT.surv.w, D.w, DD.w, Index.w_noC)
rownames(tableALL.JFM1.w.surv)="JFM1.w"
####### JIPTW1
tableALL.JIPTW1.surv=JIPTW1(X, nT, DA, A, N, Index_T_HC0, Index_T_HC1, ATT.surv, D, DD, Index_noC)
rownames(tableALL.JIPTW1.surv)="JIPTW1"
tableALL.JIPTW1.w.surv=JIPTW1(X.w, nT.w, DA.w, A.w, N.w, Index.w_T_HC0, Index.w_T_HC1, ATT.surv.w, D.w, DD.w, Index.w_noC)
rownames(tableALL.JIPTW1.w.surv)="JIPTW1.w"
##### JFM2
...
# NPD
start.time <- Sys.time()
tableALL.NPD=NPD(nT, DA, A, N, ATT.surv, "NPD.surv", trt, extD)
rownames(tableALL.NPD)="NPD"
tableALL.NPD.w=NPD(nT.w, DA.w, A.w, N.w, ATT.surv.w, "NPD.surv", trt.w, extD.w)
...
# IPD
start.time <- Sys.time()
tableALL.IPD=IPD(nT, DA, A, N, ATT.surv, "IPD.surv", trt, extD)
rownames(tableALL.IPD)="IPD"
tableALL.IPD.w=IPD(nT.w, DA.w, A.w, N.w, ATT.surv.w, "IPD.surv", trt.w, extD.w)
...
tableALL.WPD.w=WPD(nT.w, DA.w, A.w, N.w, ATT.surv.w, "WPD.surv", trt.w, extD.w)
...
gg55=ggplot(data_mse_freq.aft, aes(x=Scenario, y=MSE, group=Methods_grp)) +
  ...
  theme(plot.title = element_text(hjust = 0.5)) + ylim(0,1.2)
